<header class="main-header">
  <div class="header-container">
    <div class="logo-section">
      <img src="./assets/images/logo.png" alt="Logo Pizza Universe" class="logo-img">
      <div class="logo-text">
        <h1>Pizza <span>Universe</span></h1>
        <p class="tagline">Sabores que conquistam o universo</p>
      </div>
    </div>
